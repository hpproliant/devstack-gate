...
function update_ironic {
    ...
    # merged.
    git fetch ssh://Nisha@review.openstack.org:29418/openstack/ironic refs/changes/03/302403/4 && git cherry-pick FETCH_HEAD
    git fetch ssh://Nisha@review.openstack.org:29418/openstack/ironic refs/changes/79/264579/29 && git cherry-pick FETCH_HEAD
    git fetch ssh://Nisha@review.openstack.org:29418/openstack/ironic refs/changes/90/264590/21 && git cherry-pick FETCH_HEAD
